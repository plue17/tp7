...
func TestMarkFile_Ignore(t *testing.T) {
	...
	if err := lib.MarkFile("rec001.wav", ActionIgnore, "", "", 0); err != nil {
...
func TestMarkFile_Copied(t *testing.T) {
	...
	if err := lib.MarkFile("rec002.wav", ActionCopied, "music", "", 0); err != nil {
		t.Fatalf("MarkFile: %v", err)
	}
...
func TestMarkFile_EmptyFilename(t *testing.T) {
	...
	if err := lib.MarkFile("", ActionIgnore, "", "", 0); err == nil {
